...
def get_all_device_infos(page_size: int, page: int, text_search: Optional[str] = None, sort_property: Optional[str] = None, sort_order: Optional[str] = None, include_customers: Optional[bool] = None, device_profile_id_json: str) -> str:
    """
...
def get_customer_device_infos(customer_id_json: str, page_size: int, page: int, type: Optional[str] = None, device_profile_id_json: str, text_search: Optional[str] = None, sort_property: Optional[str] = None, sort_order: Optional[str] = None, active: Optional[bool] = None, include_customers: Optional[bool] = None) -> str:
    """
...
def save_device_group_ota_package(body_json: str) -> str:
    """
...
def save_device_with_credentials(body_json: str, entity_group_id: Optional[str] = None, entity_group_ids: Optional[str] = None) -> str:
    """
