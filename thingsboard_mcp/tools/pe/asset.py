...
def get_all_asset_infos(page_size: int, page: int, text_search: Optional[str] = None, sort_property: Optional[str] = None, sort_order: Optional[str] = None, include_customers: Optional[bool] = None, asset_profile_id_json: str) -> str:
    """
...
def get_user_assets(page_size: int, page: int, type: Optional[str] = None, text_search: Optional[str] = None, sort_property: Optional[str] = None, sort_order: Optional[str] = None, asset_profile_id_json: str) -> str:
    """
...
def process_asset_bulk_import(body_json: str) -> str:
    """
...
def save_asset(body_json: str, entity_group_id_json: str, entity_group_ids: Optional[str] = None) -> str:
    """
